...
export default () => {
  ...
  return (
    <main className="w-full custom-height flex flex-col items-center justify-center  dark:bg-slate-800 bg-gray-50 sm:px-4">

      <div className=" w-full space-y-6  text-gray-600 sm:max-w-lg">
        <div className="text-center">
          <div className="mt-5 space-y-2">
            <h3 className="text-gray-800 text-2xl dark:text-white font-bold sm:text-3xl">Create an account</h3>
            <p className="dark:text-slate-300">Already have an account? <Link to={'/login'}><span className="font-medium dark:hover:text-sky-400 dark:text-sky-500 text-indigo-600 hover:text-indigo-500">Log In</span></Link></p>
          </div>
        </div>
        <div className="bg-white dark:bg-slate-800 p-6 shadow  sm:p-6 sm:rounded-lg">
          <form
